        ...
        try:
            ...
            if dict_get(event, "HTTP - Method") != None:
                ...
                http = HTTP(
                    ...
                    referer=dict_get(event, "HTTP - Referer"),
                    request_body=dict_get(event, "HTTP - Request Body"),
                    response_body=dict_get(event, "HTTP - Response Body"),
                    request_headers=dict_get(event, "HTTP - Request Headers"),
                    http_version=dict_get(event, "HTTP - Version"),
                    response_headers=dict_get(event, "HTTP - Response Headers"),
                    file=file,
