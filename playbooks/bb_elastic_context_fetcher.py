...
from lib.class_helper import Detection, DetectionReport, Rule, ContextProcess, ContextLog, ContextFlow, ContextFile, AuditLog
...
def bb_get_context_process_parents(playbook_name, playbook_step, mlog, detection_report: DetectionReport, detection: Detection):
...
def bb_get_context_process_children(playbook_name, playbook_step, mlog, detection_report: DetectionReport, detection: Detection):
...
def bb_get_context_process_network_flows(
    playbook_name, playbook_step, mlog, detection_report: DetectionReport, detection: Detection
):
...
def bb_get_context_process_file_events(
    playbook_name, playbook_step, mlog, detection_report: DetectionReport, detection: Detection
):
...
def bb_get_context_process_registry_events(
    playbook_name, playbook_step, mlog, detection_report: DetectionReport, detection: Detection
):
